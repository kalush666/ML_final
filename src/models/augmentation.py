...
class SpecAugment(layers.Layer):
    ...
    def call(self, inputs, training=None):
        ...
        augmented = self._apply_frequency_masking(augmented, batch_size, time_steps, freq_bins)
        augmented = self._apply_time_masking(augmented, batch_size, time_steps, freq_bins)
        
        return augmented
    
    def _apply_frequency_masking(self, inputs, batch_size, time_steps, freq_bins):
        augmented = inputs
    ...
    def _apply_time_masking(self, inputs, batch_size, time_steps, freq_bins):
        augmented = inputs
